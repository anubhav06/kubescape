...
require (
	...
	github.com/aquasecurity/trivy v0.43.1 // indirect
...
replace github.com/project-copacetic/copacetic => github.com/anubhav06/copacetic v0.0.0-20230802131348-585b82de8f0c
